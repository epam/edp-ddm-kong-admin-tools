...
{{- if .Values.global.registry.kong.istio.sidecar.resources.limits.cpu }}
sidecar.istio.io/proxyCPULimit: {{ .Values.global.registry.kong.istio.sidecar.resources.limits.cpu | quote }}
{{- end }}
{{- if .Values.global.registry.kong.istio.sidecar.resources.limits.memory }}
sidecar.istio.io/proxyMemoryLimit: {{ .Values.global.registry.kong.istio.sidecar.resources.limits.memory | quote }}
{{- end }}
{{- if .Values.global.registry.kong.istio.sidecar.resources.requests.cpu }}
sidecar.istio.io/proxyCPU: {{ .Values.global.registry.kong.istio.sidecar.resources.requests.cpu | quote }}
{{- end }}
{{- if .Values.global.registry.kong.istio.sidecar.resources.requests.memory }}
